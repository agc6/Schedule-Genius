...
import { addDoc, query, collection, onSnapshot, updateDoc, doc, deleteDoc } from 'firebase/firestore';
...
function App() {
  ...
  const [input, setInput] = useState(''); //eventually this will be from input field
  //create todo
  const createTodo = async (e) => {
    e.preventDefault(e) // prevent page from refreshing
    if(input === '') {
